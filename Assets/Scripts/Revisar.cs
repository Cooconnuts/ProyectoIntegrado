...
/* ---------- DUDAS ----------
 * 
 * Estados del cuadro de luces
 * 
 * Menú principal: no hay cuadro de luces, por lo que o quitar el booleano o hacer que empiece en true 
 * Nivel bajo: que el booleano empiece en true para que las luces se puedan activar desde el principio
 * Nivel alto: que el booleano empiece en false ya que en este nivel hay que activarlo para hacer funcionar las luces
 * 
 * El teléfono móvil está en el baño de la primera planta, ¿cómo hago para que cuando se coja el movil aparezca el panel con la información?
 * ¿Puedo hacerlo como un objeto interactivo y que al cogerse o al usarse hacer que aparezca el panel con el SetActive?
 * 
 * 
 * 
...
/* ---------- PROBLEMAS ----------
 * 
 * Cuando cargo una escena desde el menu principal con las gafas no me deja moverme, es como si estuviera atascado en algo o como si no reconociese los mandos 
 * 
 ...
 * ¿Cómo puedo hacer que el botón se resalte? Con las opciones que tienen los botones de la UI no parece funcionar cuando se interactua con el puntero, ¿a lo mejor debería hacerlo objeto interactivo?
 * 
